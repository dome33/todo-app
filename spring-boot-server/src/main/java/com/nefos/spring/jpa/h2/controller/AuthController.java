...
import com.nefos.spring.jpa.h2.payload.request.LoginRequest;
import com.nefos.spring.jpa.h2.payload.request.SignupRequest;
import com.nefos.spring.jpa.h2.payload.response.UserInfoResponse;
import com.nefos.spring.jpa.h2.payload.response.MessageResponse;
...
public class AuthController {
  ...
  public ResponseEntity<?> logoutUser() {
    ...
    String cookieDetails = cookie.toString();
    logger.info("Full ResponseCookie String: " + cookieDetails);
